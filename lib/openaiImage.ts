...
Create one optimized packaging design concept by editing the uploaded main pack image.
...
- Output only the optimized packaging design concept on a clean neutral background.`;
}
